    ...
    200: {
        ...
        items: Array<{
            ...
            llm: {
                 ...
                 */
                model?: 'gpt-4o' | 'claude-3-5-haiku-latest' | 'claude-3-7-sonnet-latest' | 'claude-4-sonnet-20250514' | 'grok-2-latest' | 'grok-3-beta' | 'deepseek-chat' | 'o3-mini' | 'gpt-4o-mini' | 'huggingface-eva' | 'huggingface-dolphin-llama' | 'asi1-mini' | 'gpt-5' | 'gpt-5-mini' | 'gpt-5-nano';
                /**
